...
Entity Set is a collection (set) of similar entities that:
...
| N : 1       | Many-to-one  | -> courses taken by a student
...
- Multiple similar lower-level entities are combined into A higher-level 
...
EMPLOYEE(EmpID, Name), TEACHER inherits EMPLOYEE
